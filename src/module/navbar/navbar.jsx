    ...
    <>
      ...
      <div className="bg-transparent fixed top-0 left-0 right-0 w-full z-[100] flex items-center justify-center py-2.5 px-4">
        <div className="relative z-[1] flex items-center w-full py-1 px-2 rounded-[10px] bg-transparent overflow-x-auto [scrollbar-width:none] [-webkit-overflow-scrolling:touch]">
          ...
          <label
            className={`peer/lb1 peer-checked/rd1:text-[#ffffff] peer-checked/rd1:[text-shadow:0_0_8px_rgba(255, 255, 255,0.6)] ${labelBase}`}
            htmlFor="rd-1"
          ...
          <label
            className={`peer/lb2 peer-checked/rd2:text-[#ffffff] peer-checked/rd2:[text-shadow:0_0_8px_rgba(255, 255, 255,0.6)] ${labelBase}`}
            htmlFor="rd-2"
          ...
          <label
            className={`peer/lb3 peer-checked/rd3:text-[#ffffff] peer-checked/rd3:[text-shadow:0_0_8px_rgba(255, 255, 255,0.6)] ${labelBase}`}
            htmlFor="rd-3"
          ...
          <label
            className={`peer/lb4 peer-checked/rd4:text-[#ffffff] peer-checked/rd4:[text-shadow:0_0_8px_rgba(255, 255, 255,0.6)] ${labelBase}`}
            htmlFor="rd-4"
          ...
          <label
            className={`peer/lb5 peer-checked/rd5:text-[#ffffff] peer-checked/rd5:[text-shadow:0_0_8px_rgba(255, 255, 255,0.6)] ${labelBase}`}
            htmlFor="rd-5"
          ...
          <div className="absolute z-0 origin-[0_0_0] transition-transform duration-500 ease-[cubic-bezier(0.33,0.83,0.99,0.98)] rounded-none bg-transparent border-0 border-b-2 border-b-[#ffffff] left-2 h-[calc(100%_-_16px)] w-[calc((100%_-_16px)/5)] peer-checked/rd1:translate-x-0 peer-checked/rd2:translate-x-full peer-checked/rd3:translate-x-[200%] peer-checked/rd4:translate-x-[300%] peer-checked/rd5:translate-x-[400%] peer-hover/lb1:translate-x-0 peer-hover/lb2:translate-x-full peer-hover/lb3:translate-x-[200%] peer-hover/lb4:translate-x-[300%] peer-hover/lb5:translate-x-[400%]"></div>
        </div>
      </div>
    </>
  )
